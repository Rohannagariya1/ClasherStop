...
class TransportConfiguratorWithBifurcation {
    configureTransports(options) {
        ...
        if (options.fileOptions && options.fileOptions.logLevel) {
            ...
            const providedLevelIndex = allLevels === null || allLevels === void 0 ? void 0 : allLevels.indexOf((_a = options === null || options === void 0 ? void 0 : options.fileOptions) === null || _a === void 0 ? void 0 : _a.logLevel);
            // Determine levels to include based on the provided log level
            let levelsToInclude = [];
            if (options.fileOptions.enableFile) {
                levelsToInclude = allLevels === null || allLevels === void 0 ? void 0 : allLevels.slice(0, providedLevelIndex + 1);
            }
